...
for name, from_person in [("sara", from_sara), ("chris", from_chris)]:
    for path in from_person:
        ...
        # temp_counter += 1
        # if temp_counter < 200:
        path = os.path.join('/home/ahmed/Downloads/enron/', path[:-1])
        # print(f"Oppening file {path} ")
        email = open(path, "r")
        ...
        list_rep = ["sara", "shacleton", "chris", "germani", "sshacklensf", "cgermannsf"]
        for word in list_rep:
